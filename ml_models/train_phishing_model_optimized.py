...
try:
    ...
    print("scikit-learn (and joblib) are required. Install with: pip install scikit-learn")
    sys.exit(1)
...
MODEL_PATH = os.path.join(os.path.dirname(__file__), "phishing_model_optimized.pkl")
...
def main():
    ...
    joblib.dump(artifact, MODEL_PATH, compress=("zlib", 3))
